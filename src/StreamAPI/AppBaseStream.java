...
public class AppBaseStream {
    public static void main(String[] agrs) {
        ...
        * Создание потока - Списки .stream(), массивы Arrays.stream(T[] array), перечисление значений of(T..values)
        * Применение к потоку ряда промежуточных операций - фильтрация, перебор, отбражение, сортировка и т.п.
