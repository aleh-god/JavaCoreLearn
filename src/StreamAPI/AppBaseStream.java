...
public class AppBaseStream {
    public static void main(String[] agrs) {
        ...
        * Создание потока, для каждого решения нужен новый, значений Int, Long, Double, String, Object и тп -> Списки, массивы .stream(T[] array), перечисление значений of(T..values)
